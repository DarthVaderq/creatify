        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="flex items-center space-x-2">
              <img src="src/shared/assets/footer-images/black-email.png" alt="Email" className="w-6 h-6" />
              <span className="text-gray-800">Billshifr95@gmail.com</span>
            </div>
            <div className="flex items-center space-x-2">
            <img src="src/shared/assets/footer-images/contact.png" alt="Phone" className="w-6 h-6" />
          ...
          <div className="my-6 mr-[240px] md:my-0">
            <img src="src/shared/assets/logo.png" alt="Creatify Logo" className="w-16 h-16 mx-auto" />
          </div>

          {/* Социальные иконки */}
          <div className="flex space-x-4">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
            <img src="src/shared/assets/footer-images/facebook.png" className="w-8 h-8" />
            </a>
            <a href="https://google.com" target="_blank" rel="noopener noreferrer">
            <img src="src/shared/assets/footer-images/google.png" className="w-8 h-8" />
            </a>
            <a href="https://telegram.org" target="_blank" rel="noopener noreferrer">
              <img src="src/shared/assets/footer-images/telegram.png" alt="Telegram" className="w-8 h-8" />
            </a>
          </div>
        </div>
